...
class SectionComponent(Document):
	pass
...
def get_component_details():
	try:
		...
		for each_grp in groups:
			...
			query_2 = ''' SELECT name as unique_id,allow_update_to_style,css_field_list,title as name,css_field_list FROM `tabSection Component` WHERE group_name="%s"'''%each_grp.group_name
